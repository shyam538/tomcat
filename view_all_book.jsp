...
%>
    ...
    <div class="center_content">
      ...
      <div class="title_welcome">All Booking Details</div>
	 ...
	 <div style="position:absolute; left: 146px; top: 262px; width: 745px; height: 200px;" class="sd">
		...
		<tr bgcolor="#FFCEB7">
          ...
          <tr bgcolor="#FFE1FF"> 
              ...
              <th width="69"> <font color="#FF0000" size="2"><strong>Total Guests</strong></font></th>
				...
				<th width="69"> <font color="#FF0000" size="2"><strong>Work Asigned to</strong></font></th>
                 <th width="69"> <font color="#FF0000" size="2"><strong>Employee Action</strong></font></th>
  ...
  int a=0;
  String b = null,c = null,d=null,g=null,h=null,i=null,j=null,k=null,l=null,m=null,n=null,o=null,p=null;
	...
	try
       ...
       // st = con.createStatement();
		st = con.prepareStatement("select * from  booking order by date ");
		rs = st.executeQuery();
		while(rs.next())
       	{
		   ...
		   m=rs.getString("total");
		    n=rs.getString("bill");
			o=rs.getString("workto");
			p=rs.getString("emp_action");
	%>
          <tr bgcolor="#C1E0FF"> 
			  ...
			  <td> <strong><font size="2"><%=o%></font></strong> 
			   ...
			   <td> <strong><font size="2"><%=p%></font></strong> 
