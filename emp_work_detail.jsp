...
%>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="emp_login.jsp" ><strong><font color="#FFFFFF"><font size="3">Home</font></font></strong></a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; <a href="emp_login.jsp" ><strong><font color="#FFFFFF"><font size="3">Back</font></font></strong></a> &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="index.html" ><strong><font color="#FFFFFF"><font size="3">Logout</font></font></strong></a> 
  </div>
    ...
    <div class="center_content">
      ...
      <div class="title_welcome">Work Details</div>
	  ...
	  <div style="position:absolute; left: 140px; top: 289px; width: 745px; height: 200px;" class="sd">
  ...
  String b = null,c = null,d=null,g=null,h=null,i=null,j=null,k=null,l=null,m=null,n=null,o=null;
	...
	try
       ...
       // st = con.createStatement();
		st = con.prepareStatement("select * from  booking where workto='"+empname+"' && emp_action='"+s+"' order by date ");
		rs = st.executeQuery();
		while(rs.next())
       	{
	...
	%>
          <tr bgcolor="#C1E0FF"> 
			  ...
			  <td> <strong><font size="2"><%=n%></font></strong> 
			   ...
			   <td> <strong><font size="2"><a href="emp_view_dec.jsp?<%=a%>">More_Details</a></font></strong> 
